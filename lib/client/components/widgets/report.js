      ...
      <div className="report">
        <div className="row">
          <div className="cell">
            ...
            <AreaChart data={messageFlowRate} width="1000" tooltip={flowPopup}></AreaChart>
          </div>
        </div>
        ...
        <div className="row">
          <div className="cell">
            ...
            <BarChart data={micro1} width="600" tooltip={microPopup}></BarChart>
          </div>
          <div className="cell">
            <div className="chart-titlebar">Project commit</div>
            <LineChart data={commits} width="400" tooltip={commitPopup}></LineChart>
          </div>
        </div>
        ...
        <div className="row">
          <div className="cell">
            ...
            <LineChart data={memory} width="500" xlabel="minutes" ylabel="memory %" tooltip={memPopup}></LineChart>
          </div>
          <div className="cell">
            <div className="chart-titlebar">CPU</div>
            <LineChart data={CPU} width="500" xlabel="minutes" ylabel="cpu %" tooltip={cpuPopup} ></LineChart>
          </div>
        </div>
      </div>
    )
