  ...
  render: function () {
    ...
    return (
      <div className="report">
        ...
        <div className="row">
          <BoxHeader icon={'fa fa-line-chart'} title={'req:part, role:info'} />
          <LineChart data={req} height={150} width={width * 0.98} />
        </div>
        <div className="row">
          <BoxHeader icon={'fa fa-line-chart'} title={'res:part, role:info'} />
          <LineChart data={res} height={150} width={width * 0.98} />
        </div>
        <div className="row">
          <BoxHeader icon={'fa fa-line-chart'} title={'cmd:get, role:npm'} />
